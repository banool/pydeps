...
def parse_args(argv=()):
    ...
    args.add('--sigmajs', action='store_true', help="write sigma.js compatible json to output file")
    args.add('--connectedness', action='store_true', help="for each module, print how many files import it to stdout")
